...
class LoggedInLinks extends React.Component {
  ...
  render() {
    ...
    return (
      <ul className="right">
        <li><NavLink to={"/Wireframer/"+this.props.uid} onClick={this.handleLogout}>Log Out</NavLink></li> {/* I left NavLink instead of anchor tag because I'm using airbnb eslint rules */}
